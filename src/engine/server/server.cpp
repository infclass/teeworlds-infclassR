...
/* INFECTION MODIFICATION START ***************************************/
	...
	SetFireDelay(INFWEAPON_ELECTRICIAN_LASER, 250);
	SetFireDelay(INFWEAPON_CHAINING_LASER, 500);
	...
	SetAmmoRegenTime(INFWEAPON_ELECTRICIAN_LASER, 6000);
	...
	SetMaxAmmo(INFWEAPON_ELECTRICIAN_LASER, 10);
