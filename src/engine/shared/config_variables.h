...
MACRO_CONFIG_INT(InfLastEnforcerTimeMs, inf_last_enforcer_time_ms, 2000, 0, 10000, CFGFLAG_SERVER, "For how long the last hooker will be treated as the indirect killer (in ms)")
