...
MACRO_CONFIG_STR(SvMaprotation, sv_maprotation, 768, "infc_lunaroutpost infc_skull infc_warehouse infc_damascus infc_eidalfitr infc_newdust infc_hardcorepit infc_normandie infc_deathdealer infc_bamboo3 infc_halfdust infc_warehouse2 infc_malinalli_k9", CFGFLAG_SERVER, "Maps to rotate between")
