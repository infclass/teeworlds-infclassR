...
MACRO_CONFIG_INT(InfFKingLimit, inf_fking_limit, 1, 0, 64, CFGFLAG_SERVER, "Maximum number of fkings in game")
...
MACRO_CONFIG_INT(InfFKingPowers, inf_fking_bombs, 3, 1, 16, CFGFLAG_SERVER, "Number of bombs for the fking")
...
MACRO_CONFIG_INT(InfEnableFKing, inf_enable_fking, 1, 0, 1, CFGFLAG_SERVER, "Makes the fking class available")
